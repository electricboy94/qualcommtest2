...
class SensorServer(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            sn1 = c2#((c2 - 295) - ((-0.9) * (c3 - 282))) * 4.386*10**(-1)
            ...
            sn4 = ((c8 - 345) - ((1.5) * (c9 - 255))) * 3.145*0.2
            ...
            pm25 = 0.518 + 0.00274*(240.0*(c10)**6 - 2491.3*(c10)**5 + 9448.7*(c10)**4 - 14840.0*(c10)**3 + 10684.0*(c10)**2 + 2211.8*(c10) + 7.9623)*1.5*2.7*10**(-17)+7
