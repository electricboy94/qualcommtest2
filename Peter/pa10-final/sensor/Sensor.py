...
class SensorServer(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            sn1 = ((c2-347)-(0.03*(c3-296)))*0.00375
            ...
            pm25 = 0.518 + 0.00274*(240.0*(c10)**6 - 2491.3*(c10)**5 + 9448.7*(c10)**4 - 14840.0*(c10)**3 + 10684.0*(c10)**2 + 2211.8*(c10) + 7.9623)*10**(-16)
